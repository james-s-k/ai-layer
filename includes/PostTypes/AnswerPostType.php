...
class AnswerPostType {
	...
	public function register_post_type(): void {
		...
		register_post_type( self::POST_TYPE, [
			'labels' => [
				'name'               => __( 'Answers',                'ai-layer' ),
				'singular_name'      => __( 'Answer',                 'ai-layer' ),
				'add_new'            => __( 'Add New Answer',          'ai-layer' ),
				'add_new_item'       => __( 'Add New Answer',          'ai-layer' ),
				'edit_item'          => __( 'Edit Answer',             'ai-layer' ),
				'view_item'          => __( 'View Answer',             'ai-layer' ),
				'search_items'       => __( 'Search Answers',          'ai-layer' ),
				'not_found'          => __( 'No answers found.',       'ai-layer' ),
				'not_found_in_trash' => __( 'No answers in trash.',    'ai-layer' ),
				'menu_name'          => __( 'Answers',                 'ai-layer' ),
			],
			'public'              => false,
